...
use App\Services\IndirectChannelImportService;
...
class IndirectChannelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $cardsDef = [
            [
                ...
                'col' => 'digital_marketing_budget',
                'icon_html' => '<i class="bi bi-megaphone-fill"></i>',
                'bg_icon' => 'bg-red-500',
            ],
            [
                'key' => 'cvm',
                'title' => 'CVM Program',
                'col' => 'cvm_program_budget',
                'icon_html' => '<i class="bi bi-graph-up-arrow"></i>',
                'bg_icon' => 'bg-blue-500',
            ],
            [
                'key' => 'eo',
                'title' => 'Engagement Outlet',
                'col' => 'engagement_outlet_budget',
                'icon_html' => '<i class="bi bi-shop"></i>',
                'bg_icon' => 'bg-emerald-500',
            ],
            [
                'key' => 'bo',
                'title' => 'Branding Outlet',
                'col' => 'branding_outlet_budget',
                'icon_html' => '<i class="bi bi-award-fill"></i>',
                'bg_icon' => 'bg-purple-500',
            ],
            [
                'key' => 'pso',
                'title' => 'Program Sales Outlet',
                'col' => 'program_sales_outlet_budget',
                'icon_html' => '<i class="bi bi-tag-fill"></i>',
                'bg_icon' => 'bg-amber-500',
            ],
            [
                'key' => 'vg',
                'title' => 'Voucher Games Program',
                'col' => 'voucher_games_budget',
                'icon_html' => '<i class="bi bi-controller"></i>',
        ...
        // History Table Filtered by History Filter ($selectedHistoryCluster)
        $expensesQuery = IndirectChannelExpense::query();
        ...
        if ($selectedProgram !== 'all') {
            $progNameMap = [
                ...
                'cvm' => 'CVM Program',
                'eo' => 'Engagement Outlet',
                'bo' => 'Branding Outlet',
                'pso' => 'Program Sales Outlet',
                'vg' => 'Voucher Games Program',
            ];
        ...
        $dbMitraMap = IndirectChannelAllocation::whereNotNull('mitra')
            ->where('mitra', '!=', '')
        ...
        return view('budget-bk.indirect-channel.index', compact(
            'clusterMap',
            'selectedCluster',
    ...
    public function export(Request $request)
    {
        ...
        $query = IndirectChannelExpense::query();
        ...
        $filename = 'export_indirect_channel_' . date('Y-m-d_H-i-s') . '.csv';
    ...
    public function import(Request $request, IndirectChannelImportService $importService)
    {
        ...
        try {
            ...
            return redirect()->back()->with('success', 'Data Indirect Channel berhasil di-import.');
        } catch (\Exception $e) {
    ...
    public function storeExpense(Request $request)
    {
        ...
        IndirectChannelExpense::create($validated);
    ...
    {
        $expense = IndirectChannelExpense::findOrFail($id);
