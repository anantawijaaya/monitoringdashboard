...
use App\Services\DirectSalesImportService;
...
class DirectSalesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $cardsDef = [
            [
                ...
                'icon_html' => '<i class="fa-solid fa-cart-shopping"></i>',
                'bg_icon' => 'bg-red-500',
            ],
            [
                'key' => 'gp',
                ...
                'icon_html' => '<i class="fa-solid fa-location-dot"></i>',
                'bg_icon' => 'bg-amber-500',
            ],
            [
                'key' => 'dls',
                'title' => 'DLS / Skul.id Support',
                'col' => 'dls_skulid_budget',
        ...
        $expensesQuery = DirectSalesExpense::query();
        ...
        $dbMitraMap = DirectSalesAllocation::whereNotNull('mitra')
            ->where('mitra', '!=', '')
    ...
    public function export(Request $request)
    {
        ...
        $query = DirectSalesExpense::query();
        ...
        $filename = 'export_direct_sales_' . date('Y-m-d_H-i-s') . '.csv';
    ...
    public function import(Request $request, DirectSalesImportService $importService)
    {
        ...
        try {
            ...
            return redirect()->back()->with('success', 'Data Direct Sales berhasil di-import.');
        } catch (\Exception $e) {
    ...
    public function storeExpense(Request $request)
    {
        ...
        DirectSalesExpense::create($validated);
    ...
    {
        $expense = DirectSalesExpense::findOrFail($id);
