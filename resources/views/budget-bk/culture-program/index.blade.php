    ...
    <div class="flex-1 flex min-h-0 overflow-hidden relative">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-full overflow-hidden bg-[#F8FAFC]">
            ...
            <main class="flex-1 overflow-y-auto p-6 sm:p-8 space-y-6">
                ...
                @include('budget-bk.culture-program.partials.summary-cards')

                @include('budget-bk.culture-program.partials.cards-grid')

                @include('budget-bk.culture-program.partials.table-history')

            </main>
        </div>
    </div>

    @include('budget-bk.culture-program.partials.modal-submit')

    <!-- MODAL IMPORT DATA EXCEL / CSV -->
    @if(Auth::user() && !Auth::user()->isVisitor())
        @include('budget-bk.culture-program.partials.modal-import')
    @endif

    <!-- MODAL EXPORT DATA EXCEL / CSV -->
    @include('budget-bk.culture-program.partials.modal-export')


    @include('budget-bk.culture-program.partials.scripts')
