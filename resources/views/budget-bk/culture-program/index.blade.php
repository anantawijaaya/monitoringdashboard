...
<head>
    ...
    <title>Culture Program - Monitoring Budget BK</title>
            ...
            <main class="flex-1 overflow-y-auto p-6 sm:p-8 space-y-6">
                ...
                <div class="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div class="flex items-center gap-3.5">
                        ...
                        <div>
                            <h1 class="text-xl font-extrabold text-slate-900 tracking-tight">Culture Program</h1>
                            <p class="text-xs text-slate-500 font-medium mt-0.5">Monitoring Budget BK &bull; Realisasi Anggaran Culture Program</p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="glass-card p-5 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p class="text-xs text-slate-500 mt-1">Culture Program</p>
                    </div>
                ...
                <div class="bg-white border border-slate-200 rounded-2xl p-8 text-center shadow-sm">
                    <div class="max-w-md mx-auto space-y-4">
                        ...
                        <h2 class="text-lg font-bold text-slate-900">Modul Culture Program</h2>
                        <p class="text-sm text-slate-500 leading-relaxed">
                            Direktori untuk sub menu <strong>Culture Program</strong> telah berhasil disiapkan pada: <br>
                            <code class="text-xs bg-slate-100 text-telkomsel-red px-2 py-1 rounded font-mono border border-slate-200">resources/views/budget-bk/culture-program/index.blade.php</code>
                        </p>
                        <div class="pt-2">
