<!-- Scripts for Modal & Interactivity -->
<script>
    ...
    /**
     * Mengatur buka/tutup menu dropdown profil user.
     */
    ...
    /**
     * Mengubah angka menjadi format mata uang Rupiah Indonesia (contoh: 1.000.000).
     */
    ...
    /**
     * Memperbarui tampilan nominal budget dan sisa budget pada modal form berdasarkan cluster yang dipilih.
     */
    ...
    /**
     * Mengisi tanggal dan waktu secara otomatis berdasarkan waktu realtime lokal.
     */
    ...
    /**
     * Membuka modal form untuk membuat pengajuan pengeluaran baru.
     */
    function openSubmitBudgetModal(title, budget) {
        ...
        if (form) form.action = "{{ route('budget-bk.direct-sales.expense.store') }}";
    ...
    /**
     * Membuka modal form untuk mengedit pengajuan pengeluaran yang ada.
     */
    function openEditBudgetModal(item) {
        ...
        const form = document.getElementById('submitBudgetForm');
        if (form) form.action = `/budget-bk/direct-sales/expense/${item.id}/update`;
    ...
    /**
     * Menutup modal form input/edit budgeting.
     */
    ...
    /**
     * Memvalidasi form sebelum dikirim untuk memastikan dokumen invoice sudah terpilih.
     */
    ...
    /**
     * Memproses input nominal pengeluaran secara realtime, memformat angka Rupiah, dan mengupdate sisa budget.
     */
    ...
    /**
     * Menampilkan preview nama & ukuran file dokumen invoice yang dipilih.
     */
    ...
    /**
     * Membersihkan pilihan dokumen invoice yang diupload.
     */
