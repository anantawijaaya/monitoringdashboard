...
<body class="h-full flex flex-col antialiased text-slate-800 bg-[#F8FAFC]">
    ...
    <div class="flex-1 flex min-h-0 overflow-hidden relative">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-full overflow-hidden bg-[#F8FAFC]">
            ...
            <main class="flex-1 overflow-y-auto p-6 sm:p-8 space-y-6">
                ...
                @include('budget-bk.direct-sales.partials.summary-cards')

                <!-- PROGRAM DIRECT SALES CARDS SECTION (3 WHITE CARDS GRID) -->
                @include('budget-bk.direct-sales.partials.cards-grid')

                <!-- DAFTAR PENYERAPAN BUDGET TERBARU TABLE SECTION -->
                @include('budget-bk.direct-sales.partials.table-history')
    ...
    @include('budget-bk.direct-sales.partials.modal-submit')

    <!-- MODAL IMPORT DATA EXCEL / CSV -->
    @if(Auth::user() && !Auth::user()->isVisitor())
        @include('budget-bk.direct-sales.partials.modal-import')
    @endif

    <!-- MODAL EXPORT DATA EXCEL / CSV -->
    @include('budget-bk.direct-sales.partials.modal-export')


    <!-- Scripts for Modal & Interactivity -->
    @include('budget-bk.direct-sales.partials.scripts')
