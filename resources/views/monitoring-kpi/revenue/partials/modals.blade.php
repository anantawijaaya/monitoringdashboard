    ...
    <div class="bg-white rounded-3xl max-w-2xl w-full p-6 shadow-2xl border border-gray-100 relative animate-scale-up max-h-[90vh] overflow-y-auto">
        <div class="flex items-center justify-between pb-4 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-base font-extrabold text-gray-900">Input Data Revenue Manual</h3>
        ...
        <form action="{{ route('revenue.manual') }}" method="POST" class="mt-5 space-y-5" id="formRevenueManual" onsubmit="handleManualSubmit(event)">
            ...
            <div class="p-4 rounded-2xl bg-gray-50/70 border border-gray-200/80 space-y-3">
                <div class="flex items-center gap-2 text-xs font-black text-gray-800 uppercase tracking-wide">
                    <span class="w-5 h-5 rounded-lg bg-black/50 text-white flex items-center justify-center text-[10px]">1</span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1">Nama Cluster <span class="text-gray-400 font-normal"></span></label>
            ...
            <div class="p-4 rounded-2xl bg-red-50/40 border border-red-200/70 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 text-xs font-black text-gray-800 uppercase tracking-wide">
                        <span class="w-5 h-5 rounded-lg bg-black/50 text-white flex items-center justify-center text-[10px]">2</span>
            ...
            <div class="p-4 rounded-2xl bg-blue-50/40 border border-blue-200/70 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 text-xs font-black text-gray-800 uppercase tracking-wide">
                        <span class="w-5 h-5 rounded-lg bg-black/50 text-white flex items-center justify-center text-[10px]">3</span>
            ...
            <div class="p-4 rounded-2xl bg-amber-50/40 border border-amber-200/70 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 text-xs font-black text-gray-800 uppercase tracking-wide">
                        <span class="w-5 h-5 rounded-lg bg-black/50 text-white flex items-center justify-center text-[10px]">4</span>
            ...
            <div class="p-4 rounded-2xl bg-purple-50/40 border border-purple-200/70 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 text-xs font-black text-gray-800 uppercase tracking-wide">
                        <span class="w-5 h-5 rounded-lg bg-black/50 text-white flex items-center justify-center text-[10px]">5</span>
    ...
    <div class="bg-white rounded-3xl max-w-2xl w-full p-6 shadow-2xl border border-gray-100 relative animate-scale-up max-h-[90vh] overflow-y-auto">
        <div class="flex items-center justify-between pb-4 border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-[15px] font-extrabold text-gray-900">Edit Data Revenue</h3>
                    <p class="text-xs text-gray-500" id="editModalSubtitle"></p>
                </div>
            </div>
        ...
        <form id="formRevenueEdit" onsubmit="handleEditSubmit(event)" class="mt-5 space-y-5">
            ...
            <div class="p-4 rounded-2xl bg-gray-50/70 border border-gray-200/80 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 text-xs font-black text-black-800 uppercase tracking-wide">
                        <span class="w-5 h-5 rounded-lg bg-gray-800 text-white flex items-center justify-center text-[10px]">2</span>
                        <span>REVENUE ALL</span>
                    </div>
            ...
            <div class="p-4 rounded-2xl bg-gray-50/70 border border-gray-200/80 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 text-xs font-black text-black-800 uppercase tracking-wide">
                        <span class="w-5 h-5 rounded-lg bg-gray-800 text-white flex items-center justify-center text-[10px]">3</span>
                        <span>REVENUE BROADBAND</span>
                    </div>
            ...
            <div class="p-4 rounded-2xl bg-gray-50/70 border border-gray-200/80 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 text-xs font-black text-black-800 uppercase tracking-wide">
                        <span class="w-5 h-5 rounded-lg bg-gray-800 text-white flex items-center justify-center text-[10px]">4</span>
            ...
            <div class="p-4 rounded-2xl bg-gray-50/70 border border-gray-200/80 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 text-xs font-black text-black-800 uppercase tracking-wide">
                        <span class="w-5 h-5 rounded-lg bg-gray-800 text-white flex items-center justify-center text-[10px]">5</span>
                        <span>REVENUE RGB</span>
                    </div>
            ...
            <div class="pt-4 flex items-center justify-end gap-2.5 border-t border-gray-100">
                ...
                <button type="submit" id="btnSubmitEdit" class="px-6 py-2.5 text-xs font-extrabold text-white bg-[#ED1C24] rounded-xl shadow-md transition-all flex items-center gap-2 cursor-pointer">
...
<div id="importModal" class="fixed inset-0 z-50 hidden bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-gray-100 relative animate-scale-up">
        <div class="flex items-center justify-between pb-4 border-b border-gray-100">
            <div class="flex items text-left ">
                <div>
                    <h3 class="text-base font-extrabold text-gray-900">Import Data</h3>
        ...
        <form action="{{ route('revenue.import') }}" method="POST" enctype="multipart/form-data" class="mt-5 space-y-4" id="formRevenueImport" onsubmit="handleImportSubmit(event)">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <label class="flex items-start gap-2 p-2.5 rounded-xl border border-gray-200 bg-slate-50 hover:bg-slate-100 cursor-pointer transition-colors">
                        ...
                        <div>
                            ...
                            <span class="text-[10px] text-gray-500 block"></span>
                        </div>
                    </label>
                    <label class="flex items-start gap-2 p-2.5 rounded-xl border border-gray-200 bg-slate-50 hover:bg-slate-100 cursor-pointer transition-colors">
                        <input type="radio" name="import_mode" value="append" class="mt-0.5 text-red-600 focus:ring-red-500">
                        <div>
                            <span class="font-bold text-gray-800 block text-xs leading-tight">Tambah/Update Data</span>
                            <span class="text-[10px] text-gray-500 block"></span>
                        </div>
                    </label>
                </div>
            ...
            <div class="border-2 border-dashed border-gray-200 rounded-2xl p-6 text-center hover:border-red-400 transition-colors bg-gray-50/50">
                ...
                <p class="text-[11px] text-gray-400 mt-0.5">Format yang didukung : CSV, XLSX (Maks 10MB)</p>
