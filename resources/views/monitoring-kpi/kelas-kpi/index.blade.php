...
<body class="h-full flex flex-col antialiased text-gray-900 bg-[#F8FAFC]">
    ...
    <div class="flex-1 flex min-h-0 overflow-hidden relative">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-full overflow-hidden bg-[#F8FAFC]">
            ...
            <main class="flex-1 overflow-y-auto p-6 sm:p-8 space-y-6">
                ...
                @include('monitoring-kpi.kelas-kpi.partials.view-ringkasan')

                <!-- VIEW 2: PERHITUNGAN LENGKAP KPI -->
                @include('monitoring-kpi.kelas-kpi.partials.view-lengkap')

                <!-- VIEW 3: ANALISIS DATA -->
                @include('monitoring-kpi.kelas-kpi.partials.view-analisis')
    ...
    <!-- MODALS -->
    @include('monitoring-kpi.kelas-kpi.partials.modals')

    <!-- JAVASCRIPT INTERACTIONS -->
    @include('monitoring-kpi.kelas-kpi.partials.scripts')
